    ...
    const onSubmit = async (data: FormData) => {
        ...
        if (data.email) {
            ...
            const fetchUserByEmail = async () => {
                try {
                    const userResponse = await fetch(`${BACKEND_API_URL}/user/${encodeURIComponent(data.email)}`, {
                        method: "GET",
                        headers: {
                    ...
                    if (!isUserFound.success) {
                        ...
                        setError("We have got you already!🎉🥳");
                        setIsSubmitting(false);
                    }
    ...
    return (
        ...
        >
            ...
            <div>
                ...
                >
                    Before Triage begins, your Name *
                </label>
                <input
                    id="name"
                    type="text"
                    ...
                    placeholder="Vitals are next, but first your name😊"
            ...
            <div>
                <label
                    ...
                    className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1"
                >
                    Pager's outdated - drop your email!*
                </label>
                <input
                    id="email"
                    type="email"
                    ...
                    placeholder="Vitals checked. Where can we send the updates? 📧"
                    {...register("email", {
            ...
            <div>
                ...
                <input
                    ...
                    placeholder="Let's keep in touch for smart care updates! 📞"
                    {...register("phone")}
                />
            </div>
            ...
            <div>
                ...
                <textarea
                    ...
                    rows={2}
                    className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:text-white"
                    placeholder="where can we find you for Triage? 🏠"
                    {...register("address")}
                ></textarea>
            </div>
            ...
            >
                {isSubmitting ? "Submitting..." : "Let the Triage Begin!"}
            </button>
        </form>
    );
};
