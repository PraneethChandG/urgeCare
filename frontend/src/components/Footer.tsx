      ...
      <div className="container mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
          ...
          <div>
            ...
            <div className="space-y-3">
              <div className="flex items-center space-x-3 text-gray-600 dark:text-gray-300">
                ...
                <a href="mailto:info@urgecare.co" className="hover:text-blue-600 dark:hover:text-blue-400 transition-colors">
                  info@urgecare.co
                </a>
              </div>
              <div className="flex items-center space-x-3 text-gray-600 dark:text-gray-300">
          ...
          <div>
            ...
            <div className="flex space-x-4">
              ...
              <a href="https://www.linkedin.com/company/urgecarehealth/" target="_blank" className="text-gray-600 hover:text-blue-600 dark:text-gray-300 dark:hover:text-blue-400 transition-colors">
        ...
        <div className="mt-10 pt-6 border-t border-gray-200 dark:border-gray-700 text-center">
          <p className="text-sm text-gray-600 dark:text-gray-400">
            &copy; {new Date().getFullYear()} UrgeCare. All rights reserved.
          </p>
        </div>
      </div>
    </footer>
